...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="../../index2.html"><b>Selamat Datang</b> <b>Siswa!</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">Silahkan Login untuk Siswa</p>
        <hr>
        <?php 
        if(isset($_GET['info'])){
          if($_GET['info'] == "gagal"){ ?>
          ...
          <?php } } ?>
        <br>
        <form action="cekloginsiswa.php" method="post">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <hr>
              <a href="login.php" class="btn btn-info btn-block">Login Petugas</a>
            </div>
          </div>
          <!-- /.social-auth-links -->
