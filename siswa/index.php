    ...
    <div class="content">
      ...
      <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="historypembayaran.php" class="small-box-footer">Detail <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
      </div>
          <div class="col-lg-12">
          ...
          <div class="card card-secondary card-outline" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
              <div class="card-body">
                <h6 class="card-text">Selamat Datang Siswa di Aplikasi Pembayaran SPP</h6>
              </div>
            </div>
          </div>
        <!-- /.row -->
