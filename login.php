...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="#"><b>Selamat Datang</b> <br><b>Admin dan Petugas!</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">Silahkan Login untuk Admin dan Petugas</p>
        <hr>
        <?php 
        if(isset($_GET['info'])){
          if($_GET['info'] == "gagal"){ ?>
        ...
        <form action="cekloginpetugas.php" method="post">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <hr>
              <a href="index.php" class="btn btn-primary btn-block">Login Siswa</a>
            </div>
          </div>
          <!-- /.social-auth-links -->
