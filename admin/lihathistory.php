            ...
            <div class="card-body">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                 ...
                 $no = 1;
                 include "../koneksi.php";
                 $siswa    =mysqli_query($koneksi, "SELECT * FROM siswa INNER JOIN kelas ON siswa.id_kelas=kelas.id_kelas INNER JOIN spp ON siswa.id_spp=spp.id_spp WHERE nisn='$nisn'");
                 while($d_siswa = mysqli_fetch_array($siswa)){
                  ...
                  ?>
                  <?php if($d_siswa['nisn'] == $d_siswa['nisn']) { ?>
                    <tr>
                  ...
                  <tr>
                    <td colspan="5" class="text-center"><b>Status </b> </td>
                  <td>
                      <?php if ($d_siswa['nominal'] == $sudah_bayar) { ?>
                        <div class="btn btn-success btn-sm d-grid gap-2 col-12"><b>Lunas</b></div>
                      <?php } else { ?>
                        <div class="btn btn-warning btn-sm d-grid gap-2 col-12"><b>Belum Lunas</b></div>
                      <?php } ?>
                    </td>
                  </tr>
                  <?php } else { ?>
